...
type User struct {
	...
	Email           string         `gorm:"column:email;size:255;not null;unique;unique;index;" json:"email" validate:"required,email,max=255"`
	UserName        string         `gorm:"column:user_name;size:50;not null;unique;index;" json:"user_name" validate:"required,min=4,max=50"`
